				...
				return new Container(
						...
						new Card(
							child: new Column(
								children: new List.generate(
										events.length,
												(index) =>
										events[index].eventType == EventType.waitingApproval ? new GestureDetector(
						...
						Column(
								children: new List.generate(
									events.length,
											(index) =>
									events[index].eventType == EventType.rejected ? new GestureDetector(
										onTap: () => _onTap(context, index),
										child: new Card(
											child: ListTile(
											...
											subtitle: Column(
											  children: <Widget>[
											    Text(events[index].body),
													Divider(height: 10,),
													Text(events[index].rejectionComment == null ? "":events[index].rejectionComment)
											  ],
											),
										),
									),
